...
from layers import init_weight,SmilesCNN

class DTA_graph(nn.Module):
    def __init__(self, in_dims, emb_dim, smi_hidden_dim):
        '''
        :param in_dims: 65
        :param emb_dim: 128
        :param smi_hidden_dims: 256
        '''
        super(DTA_graph, self).__init__()
        self.hidden_dim = smi_hidden_dim
        self.smile_exa = SmilesCNN(in_dim=in_dims,emb_dim=emb_dim,out_dim=smi_hidden_dim)
